...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate.setBackgroundColor(Color.parseColor("#117293"));
        btn_setDate.setTextColor(Color.WHITE);

        btn_setTime = new Button(activity);
        btn_setTime.setLayoutParams(button_params);
        btn_setTime.setText("Set Time");
        btn_setTime.setBackgroundColor(Color.parseColor("#117293"));
        btn_setTime.setId(SET_TIME);
        btn_setTime.setTextColor(Color.WHITE);
        ...
        btn_set.setText("Set");
        btn_set.setId(SET);
        btn_set.setBackgroundColor(Color.WHITE);
        btn_set.setTextColor(Color.parseColor("#117293"));
        ...
        btn_cancel.setTextColor(Color.parseColor("#117293"));
